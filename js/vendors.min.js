(function (factory) {
	typeof define === 'function' && define.amd ? define('vendors', factory) :
	factory();
})((function () { 'use strict';
	...
	!function (t, e) {
	  ...
	  Vt.Utils = ("undefined" != typeof window ? window : commonjsGlobal).PopperUtils, Vt.placements = Bt, Vt.Defaults = Ut;
